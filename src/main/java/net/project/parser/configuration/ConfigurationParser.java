...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Apr 05 16:16:54 CST 2015
  */
  ...
  public final java_cup.runtime.Symbol CUP$ConfigurationParser$do_action(
      ...
      switch (CUP$ConfigurationParser$act_num)
        {
          ...
          case 57: // DG_X_CREDIT ::= x_credit equal int_value 
            {
              Object RESULT =null;
		int creditleft = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).left;
		int creditright = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).right;
		String credit = (String)((java_cup.runtime.Symbol) CUP$ConfigurationParser$stack.peek()).value;
		 this.parser.currentCredit = credit; 
          ...
          case 56: // DG_X_DESTROY ::= x_destroy equal int_value 
            {
              Object RESULT =null;
		int destroyleft = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).left;
		int destroyright = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).right;
		String destroy = (String)((java_cup.runtime.Symbol) CUP$ConfigurationParser$stack.peek()).value;
		 this.parser.currentDestroy = destroy; 
          ...
          case 55: // DG_X_PICTURE ::= x_picture equal string_value 
            {
              Object RESULT =null;
		int pictureleft = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).left;
		int pictureright = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).right;
		String picture = (String)((java_cup.runtime.Symbol) CUP$ConfigurationParser$stack.peek()).value;
		 this.parser.currentPicture = picture; 
          ...
          case 54: // DG_X_TYPE_VALUE ::= x_weapon 
            {
              Object RESULT =null;
		this.parser.currentType = "weapon"; 
		 ...
		 this.parser.currentType = "block"; 
          ...
          case 50: // DG_X_TYPE_VALUE ::= x_finish 
            {
              Object RESULT =null;
		 this.parser.currentType = "finish"; 
              CUP$ConfigurationParser$result = parser.getSymbolFactory().newSymbol("DG_X_TYPE_VALUE",29, ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()), RESULT);
            }
          return CUP$ConfigurationParser$result;
		...
		String type = (String)((java_cup.runtime.Symbol) CUP$ConfigurationParser$stack.elementAt(CUP$ConfigurationParser$top-2)).value;
          ...
          case 48: // DG_X_NAME ::= x_name equal id 
            {
              Object RESULT =null;
		int nameleft = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).left;
		int nameright = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).right;
		String name = (String)((java_cup.runtime.Symbol) CUP$ConfigurationParser$stack.peek()).value;
		 this.parser.currentName = name; 
    ...
    this.parser.currentCredit = null;
          ...
          case 36: // FG_X_DESCRIPTION ::= x_description equal string_value 
            {
              Object RESULT =null;
		int descriptionleft = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).left;
		int descriptionright = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).right;
		String description = (String)((java_cup.runtime.Symbol) CUP$ConfigurationParser$stack.peek()).value;
		 this.parser.currentDescription = description; 
          ...
          case 35: // FG_X_DESTROY ::= x_destroy equal int_value 
            {
              Object RESULT =null;
		int valleft = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).left;
		int valright = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).right;
		String val = (String)((java_cup.runtime.Symbol) CUP$ConfigurationParser$stack.peek()).value;
		 this.parser.currentDestroy = val; 
		...
		String picture = (String)((java_cup.runtime.Symbol) CUP$ConfigurationParser$stack.peek()).value;
		 this.parser.currentPicture = picture; 
          ...
          case 15: // BG_X_NAME ::= x_name equal id 
            {
              Object RESULT =null;
		int idleft = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).left;
		int idright = ((java_cup.runtime.Symbol)CUP$ConfigurationParser$stack.peek()).right;
		String id = (String)((java_cup.runtime.Symbol) CUP$ConfigurationParser$stack.peek()).value;
		this.parser.currentName = id;
